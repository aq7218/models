...
def compute_a(sigma, q, lmbd, verbose=False):
    ...
    if verbose:
        print
        "A: by binomial expansion    {} = {} + {}".format(
            a_lambda_exact,
...
def compute_b(sigma, q, lmbd, verbose=False):
    ...
    if verbose:
        print
        "B: by numerical integration", b_lambda
        print
        "B must be no more than     ", b_bound
    print
    b_lambda, b_bound
...
def compute_a_mp(sigma, q, lmbd, verbose=False):
    ...
    if verbose:
        print
        "A: by numerical integration {} = {} + {}".format(
            a_lambda,
